...
export default function User() {
    ...
    function SlidePage({ id }) {
        const userPage = {
            1 : <Paslon popUpS={setShowPopUp} selectMisi={setMisiSelect} selectProker={setProkerSelect} />,
            2 : <About />,
            3 : <Feedback />
        }
        return userPage[id]
    ...
    return (
        < >
            ...
            <SlideBar 
                ...
                slideBar = {setSlideBarHide}
                slideBarOff = {SlideBarHide}
                switchPage = {setPage}
            />
