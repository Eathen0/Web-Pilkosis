import smpleIMG from '../../assets/IMG-20220723-WA0013.jpg';
import axios from 'axios';
import { useState, useEffect } from 'react';

export default function EditPaslon() {
    ...
    return (
        <div className="w-full flex justify-center px-10 pt-10 gap-5">
            <div className='flex flex-col items-center gap-5 p-5 w-[35rem] h-auto rounded-2xl shadow-lg shadow-black/30 bg-gradient-to-t from-gray-100 to-transparent'>
                <img className='border-2 border-gray-300 hover:rounded-xl hover:w-80 hover:h-80 transition-all duration-500 w-40 h-40 rounded-full shadow-lg shadow-black/50 object-cover' src={smpleIMG} />
                <h1 className='text-2xl'>Nama Paslon</h1>
                <div className='w-[30rem] grid gap-2'>
                    ...
                    <div className={`${isExpand == 1 && "h-full overflow-auto"} transition-all duration-500 h-10 overflow-hidden w-full rounded-md shadow-lg p-2 flex flex-col gap-2`}>
                        ...
                        <p>
                            Lorem ipsum dolor sit, amet consectetur adipisicing elit. Aperiam doloribus nostrum amet, vero perferendis reprehenderit temporibus, saepe quae, iure tenetur excepturi fugiat nihil libero a placeat voluptatibus ad facere mollitia?
                            Lorem ipsum dolor sit, amet consectetur adipisicing elit. Aperiam doloribus nostrum amet, vero perferendis reprehenderit temporibus, saepe quae, iure tenetur excepturi fugiat nihil libero a placeat voluptatibus ad facere mollitia?
                            Lorem ipsum dolor sit, amet consectetur adipisicing elit. Aperiam doloribus nostrum amet, vero perferendis reprehenderit temporibus, saepe quae, iure tenetur excepturi fugiat nihil libero a placeat voluptatibus ad facere mollitia?
                        </p>
                    </div>
