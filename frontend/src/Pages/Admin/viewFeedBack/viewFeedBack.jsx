                    ...
                    return (
                        ...
                        >
                            <label
                                ...
                                className="flex items-center bg-gradient-to-r from-blue-900/20 to-transparent border rounded-xl w-full py-2 h-18 px-5 group-hover:shadow-[1px_2px_5px_0px_gray] transition-[box-shadow] duration-500 cursor-pointer"
                            >
                                <div className="flex grow items-center gap-2">
                                    <h1 className="text-xl">Dari : </h1>
                                    <p className="self-end font-extralight text-lg">
                                        {el.nama}
                                    </p>
                                ...
                                <svg
                                    className="w-12 h-12 rounded-lg p-2 transition-[transform_opacity] duration-500 opacity-0 -translate-x-10 group-hover:translate-x-0 group-hover:opacity-100"
                                    id="Layer_1"
